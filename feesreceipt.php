...
<!-- start: Content -->
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="col-md-6 col-sm-12">
                        <h1 class="animated fadeInLeft">FEE'S</h1>
              ...
              <!-- </div> -->
                  ...
                  <div class="panel-body">
                    <button type="button" class="btn btn-primary text-white" data-toggle="modal" data-target="#myModal">
                       <a href="complatefee.php" style="color: white;">
                          Complate Fee
                       </a>
                    </button><br><br>
                    <div class="responsive-table">
                      ...
                      <tbody>
            <?php
            $sql = "SELECT * FROM admission where status=0";
            ...
            ?> 
                        <tr>
                          ...
                          <td><a href="<?php echo SITE_URL ;?>fee.php?no=<?php echo $r['enrollment'];?>">                                          
